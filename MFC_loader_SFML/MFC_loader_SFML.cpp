...
// MFC_loader_SFML.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCloaderSFMLApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCloaderSFMLApp

CMFCloaderSFMLApp::CMFCloaderSFMLApp()
{
...
// Единственный объект CMFCloaderSFMLApp

CMFCloaderSFMLApp theApp;


// Инициализация CMFCloaderSFMLApp

BOOL CMFCloaderSFMLApp::InitInstance()
{
